...
import com.android.example.rssreader.model.Channel
...
class FeedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val topics = mutableListOf<Item>()
        val rv1 = findViewById<RecyclerView>(R.id.MainActivity_recyclerview)
        rv1.layoutManager=LinearLayoutManager(this)
        adapter = ArticleListAdapter(rssFeedList)
        rv1.adapter = adapter
        // ========== PHASE 1 : to here ============================================================
